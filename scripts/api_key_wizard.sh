...
update_var "BIG_API_KEY" "\$${PROVIDER_VAR}" "$PROFILE"
update_var "BIG_ENDPOINT" "\$${PROVIDER_URL_VAR}" "$PROFILE"
...
echo "  export BIG_API_KEY=\$${PROVIDER_VAR}"
echo "  export BIG_ENDPOINT=\$${PROVIDER_URL_VAR}"
echo ""
