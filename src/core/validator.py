...
class ConfigValidator:
    ...
    def _check_api_keys(self):
        ...
        # Test main provider
        self._test_api_key(provider_url, provider_key, "Main Provider")
        ...
        for tier in ["BIG", "MIDDLE", "SMALL"]:
            ...
            if enabled:
                ...
                if endpoint and api_key:
                    self._test_api_key(endpoint, api_key, f"{tier} Endpoint")

    def _test_api_key(self, base_url: str, api_key: str, name: str):
        """Test an API key with a provider"""
