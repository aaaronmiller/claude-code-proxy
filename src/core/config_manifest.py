...
SETTINGS: List[Setting] = [
    ...
    # GROUP: models
    # ════════════════════════════════════════════════════════════════════════
    Setting("XBIG_MODEL", str, "", "XBIG tier model (frontier-level)", "models",
            cli_flag="--xbig-model", tui_widget="input", web_component="input"),
    ...
    Setting("ENABLE_XBIG_ENDPOINT", bool, False, "Enable the XBIG tier endpoint", "models",
            cli_flag="--enable-xbig-endpoint", tui_widget="toggle", web_component="switch"),
    Setting("XBIG_ENDPOINT", str, "", "XBIG tier provider endpoint", "models",
            cli_flag="--xbig-endpoint", tui_widget="input", web_component="input"),
    Setting("XBIG_API_KEY", str, "", "XBIG tier provider API key", "models",
            cli_flag="--xbig-api-key", secret=True, tui_widget="input", web_component="input"),
    Setting("ENABLE_BIG_ENDPOINT", bool, False, "Enable the BIG tier endpoint", "models",
            cli_flag="--enable-big-endpoint", tui_widget="toggle", web_component="switch"),
    Setting("BIG_ENDPOINT", str, "", "BIG tier provider endpoint", "models",
            cli_flag="--big-endpoint", tui_widget="input", web_component="input"),
    Setting("BIG_API_KEY", str, "", "BIG tier provider API key", "models",
            cli_flag="--big-api-key", secret=True, tui_widget="input", web_component="input"),
    Setting("ENABLE_MIDDLE_ENDPOINT", bool, False, "Enable the MIDDLE tier endpoint", "models",
            cli_flag="--enable-middle-endpoint", tui_widget="toggle", web_component="switch"),
    Setting("MIDDLE_ENDPOINT", str, "", "MIDDLE tier provider endpoint", "models",
            cli_flag="--middle-endpoint", tui_widget="input", web_component="input"),
    Setting("MIDDLE_API_KEY", str, "", "MIDDLE tier provider API key", "models",
            cli_flag="--middle-api-key", secret=True, tui_widget="input", web_component="input"),
    Setting("ENABLE_SMALL_ENDPOINT", bool, False, "Enable the SMALL tier endpoint", "models",
            cli_flag="--enable-small-endpoint", tui_widget="toggle", web_component="switch"),
    Setting("SMALL_ENDPOINT", str, "", "SMALL tier provider endpoint", "models",
            cli_flag="--small-endpoint", tui_widget="input", web_component="input"),
    Setting("SMALL_API_KEY", str, "", "SMALL tier provider API key", "models",
            cli_flag="--small-api-key", secret=True, tui_widget="input", web_component="input"),
    Setting("XBIG_CASCADE", str, "", "XBIG tier fallback models (comma-separated)", "models",
            cli_flag="--xbig-cascade", tui_widget="textarea", web_component="textarea"),
    ...
    Setting("XBIG_MODEL_REASONING", str, "",
            "Per-tier reasoning override for XBIG model", "reasoning",
            cli_flag="--xbig-reasoning", tui_widget="input", web_component="input"),
    ...
    Setting("SMALL_MODEL_REASONING", str, "",
            "Per-tier reasoning override for SMALL model", "reasoning",
            cli_flag="--small-reasoning", tui_widget="input", web_component="input"),

    # ════════════════════════════════════════════════════════════════════════
    # GROUP: system_prompts
    # ════════════════════════════════════════════════════════════════════════
    Setting("ENABLE_CUSTOM_XBIG_PROMPT", bool, False,
            "Enable the custom XBIG tier system prompt", "system_prompts",
            cli_flag="--enable-custom-xbig-prompt", tui_widget="toggle", web_component="switch"),
    Setting("XBIG_SYSTEM_PROMPT_FILE", str, "",
            "Path to the XBIG tier system prompt file", "system_prompts",
            cli_flag="--xbig-system-prompt-file", tui_widget="input", web_component="input"),
    Setting("XBIG_SYSTEM_PROMPT", str, "",
            "Inline XBIG tier system prompt", "system_prompts",
            cli_flag="--xbig-system-prompt", tui_widget="textarea", web_component="textarea"),
    Setting("ENABLE_CUSTOM_BIG_PROMPT", bool, False,
            "Enable the custom BIG tier system prompt", "system_prompts",
            cli_flag="--enable-custom-big-prompt", tui_widget="toggle", web_component="switch"),
    Setting("BIG_SYSTEM_PROMPT_FILE", str, "",
            "Path to the BIG tier system prompt file", "system_prompts",
            cli_flag="--big-system-prompt-file", tui_widget="input", web_component="input"),
    Setting("BIG_SYSTEM_PROMPT", str, "",
            "Inline BIG tier system prompt", "system_prompts",
            cli_flag="--big-system-prompt", tui_widget="textarea", web_component="textarea"),
    Setting("ENABLE_CUSTOM_MIDDLE_PROMPT", bool, False,
            "Enable the custom MIDDLE tier system prompt", "system_prompts",
            cli_flag="--enable-custom-middle-prompt", tui_widget="toggle", web_component="switch"),
    Setting("MIDDLE_SYSTEM_PROMPT_FILE", str, "",
            "Path to the MIDDLE tier system prompt file", "system_prompts",
            cli_flag="--middle-system-prompt-file", tui_widget="input", web_component="input"),
    Setting("MIDDLE_SYSTEM_PROMPT", str, "",
            "Inline MIDDLE tier system prompt", "system_prompts",
            cli_flag="--middle-system-prompt", tui_widget="textarea", web_component="textarea"),
    Setting("ENABLE_CUSTOM_SMALL_PROMPT", bool, False,
            "Enable the custom SMALL tier system prompt", "system_prompts",
            cli_flag="--enable-custom-small-prompt", tui_widget="toggle", web_component="switch"),
    Setting("SMALL_SYSTEM_PROMPT_FILE", str, "",
            "Path to the SMALL tier system prompt file", "system_prompts",
            cli_flag="--small-system-prompt-file", tui_widget="input", web_component="input"),
    Setting("SMALL_SYSTEM_PROMPT", str, "",
            "Inline SMALL tier system prompt", "system_prompts",
            cli_flag="--small-system-prompt", tui_widget="textarea", web_component="textarea"),
